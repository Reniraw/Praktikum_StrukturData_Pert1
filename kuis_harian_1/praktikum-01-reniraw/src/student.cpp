...
double hitungRataRata(const int data[], int n) {
    ...
    return static_cast<double>(hitungTotal(data, n)) / n;
}
...
int cariMax(const int data[], int n) {
    ...
    return maks;  // nilai sementara — ganti dengan hasil perhitungan Anda
}
...
int hapusNilai(int data[], int n, int target) {
    ...
    return ukuranBaru;  // nilai sementara — ganti dengan ukuran baru array
}
...
int indeksNilaiTertinggi(const Mahasiswa data[], int n) {
    ...
    return indeksTertinggi;  // nilai sementara — ganti dengan indeks hasil pencarian
}
...
int hitungLulus(const Mahasiswa data[], int n, double kkm) {
    ...
    return jumlahLulus;  // nilai sementara — ganti dengan hasil perhitungan Anda
}
